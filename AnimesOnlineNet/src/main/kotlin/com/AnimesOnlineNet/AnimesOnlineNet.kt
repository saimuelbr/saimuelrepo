...
class AnimesOnlineNet : MainAPI() {
    override var mainUrl = "https://animesonlinenet.com"
    override var name = "AnimesOnlineNet"
    ...
    override val mainPage = mainPageOf(
        ...
        "categorias/comedia" to "Comédia",
        "categorias/aventura" to "Aventura",
        "categorias/fantasia" to "Fantasia",
        "categorias/romance" to "Romance",
        "categorias/misterio" to "Mistério",
        "categorias/cotidiano" to "Cotidiano",
        "categorias/escolar" to "Escolar",
        "categorias/drama" to "Drama",
        "categorias/esporte" to "Esporte"
    )
    ...
    override suspend fun load(url: String): LoadResponse {
        ...
        return if (type == TvType.Anime) {
            ...
            val firstEpisodePoster = episodes.values.flatten().firstOrNull()?.posterUrl
    ...
    override suspend fun loadLinks(
        ...
        return AnimesOnlineNetExtractor.extractVideoLinks(data, mainUrl, name, callback)
    }
